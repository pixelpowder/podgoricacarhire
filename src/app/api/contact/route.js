...
export async function POST(request) {
  try {
    ...
    const sitePrefix = process.env.SITE_PREFIX || 'PG';
    const fromName = process.env.MAIL_FROM_NAME || 'Podgorica Car Hire';
    const fromAddress = process.env.MAIL_FROM || 'noreply@podgoricacarhire.com';
