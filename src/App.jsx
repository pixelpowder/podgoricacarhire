...
const LOCATIONS = [
  'Podgorica', 'Tivat', 'Kotor', 'Budva', 'Herceg-Novi',
...
const locationSelectStyles = {
  ...
  option: (base, state) => ({
    ...
    color: state.isSelected ? 'rgb(45,106,79)' : 'rgb(11,38,24)',
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(([entry]) => {
      if (entry.isIntersecting) {
        const load = () => setIframeSrc('/widget.html?city_id=41&hide_search=1&v=12');
  ...
  return (
    <div className="trustpilot-banner" style={{ display: visible ? 'block' : 'none' }}>
      <div className="container">
        ...
        >
          <a href="https://www.trustpilot.com/review/podgoricacarhire.com" target="_blank" rel="noopener">Trustpilot</a>
        </div>
      </div>
    </div>
  );
      ...
      <div className="cta-banner__inner">
        <div className="reveal-up">
          ...
          <div className="cta-banner__actions">
            ...
            <a href="mailto:info@podgoricacarhire.com" className="cta-btn--outline">
              <Mail size={15} /> info@podgoricacarhire.com
            </a>
          </div>
        </div>
      </div>
