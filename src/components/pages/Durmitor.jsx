...
export default function Durmitor() {
  ...
  return (
    <ContentPage title={t("durmitor.title")} subtitle={t("durmitor.subtitle")} description={t("durmitor.seoDesc")} image="/img/pexels-4264818.jpg">
      <img src="/img/pexels-27151410.jpg" alt="Durmitor mountains" loading="lazy" />
