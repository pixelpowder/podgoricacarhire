...
export default function BorderCrossing() {
  ...
  return (
    <ContentPage title={t("border-crossing.title")} subtitle={t("border-crossing.subtitle")} description={t("border-crossing.seoDesc")} image="/img/mountain-road.webp">
      <img src="/img/mountain-road.webp" alt="Montenegro border road" loading="lazy" />
      ...
      <img src="/img/moraca-canyon.webp" alt="Montenegro mountain road" loading="lazy" />
