...
export default function Tivat() {
  ...
  return (
    <ContentPage title={t("tivat.title")} subtitle={t("tivat.subtitle")} description={t("tivat.seoDesc")} image="/img/podgorica-airport.webp">
      <img src="/img/podgorica-airport.webp" alt="Tivat" loading="lazy" />
      ...
      <img src="/img/budva-coast.webp" alt="Tivat waterfront" loading="lazy" />
