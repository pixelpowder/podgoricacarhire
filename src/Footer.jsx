...
// 5 representatives of the TGD fleet — surfaces car guides from the footer.
const FOOTER_FLEET_SLUGS = [
  'vw-polo', 'renault-clio', 'toyota-yaris', 'peugeot-308', 'kia-stonic',
];
      ...
      <div className="footer__grid">
        ...
        <FooterColumn title={t('footer.locations')}>
          {[
            ...
            { name: 'Lake Skadar', slug: 'lake-skadar' },
